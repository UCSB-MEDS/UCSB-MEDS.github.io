...
- Run the following in the RStudio Console which should open a browser window with a page that looks like this: 
...
*You made need to go through the following steps to install Docker on a PC.*
