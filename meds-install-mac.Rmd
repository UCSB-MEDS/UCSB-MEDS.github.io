...
- **New install:** To install RStudio, visit [rstudio.com/products/rstudio/](https://www.rstudio.com/products/rstudio/). Download the free (“Open Source Edition”) Desktop version for your operating system. You should have at least v2022.02 installed to start MEDS (but we recommend installing the most up-to-date version available!).
...
#### 3. Install Quarto (*if necessary - update as of 07/28/2022)
