...
author: 
- name: Halina Dol-Linh and Clarissa Boyajian
date: 2022-01-06
output:
...
Now that our proposal has been submitted (and selected!), we're just getting started. We've taken some time to reflect on the proposal process. There's a lot we've learned and we've compiled our most essential thoughts below.
...
- Whose 'way of knowing' are privileged? Is there a type of evidence or data that is privileged over others? Is the world view of the dominant group causing harm? 
