...
### Message retention
We maintain a Free Slack workspace, which means messages will be deleted after we reach 10,000 messages across all channels. If you think that your conversation should be saved for future reference, we encourage you to move that conversation to email or GitHub issues.
