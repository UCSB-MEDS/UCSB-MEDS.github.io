...
fall[1,2] <- cell_spec("Working with Environmental Datasets",  "html", link = "https://samanthastevenson.github.io/EDS220_Fall2022_site/")
...
# Update 223 title cell (w/ link) - REMOVED LINK FOR NOW (5/27/2022) BC RUTH TAKING OVER
# fall[3,2] <- cell_spec("Geospatial Analysis & Remote Sensing",  "html", link = "https://jamesfrew.github.io/EDS_223_spatial_analysis/")

# NO LONGER IN FALL 2022
...
winter[1,2] <- cell_spec("Team Science, Collaborative Analysis and Project Management",  "html", link = "https://bbest.github.io/eds211-team/")

# Update 232 title cell (w/ link)
winter[2,2] <- cell_spec("Machine Learning in Environmental Science",  "html", link = "https://bbest.github.io/eds232-ml/")

# Update 411 title cell (w/ link)
winter[5,2] <- cell_spec("MEDS Capstone Course", "html", link = "https://allisonhorst.github.io/EDS_411AB_meds-capstone/")
...
spring[3,2] <- cell_spec("Text and Sentiment Analysis for Environmental Problems", "html", link = "https://maro406.github.io/EDS_231-text-sentiment/")

# Update 411 title cell (w/ link)
spring[4,2] <- cell_spec("MEDS Capstone Course", "html", link = "https://allisonhorst.github.io/EDS_411AB_meds-capstone/")
