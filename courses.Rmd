...
winter[1,2] <- cell_spec("Machine Learning in Environmental Science",  "html", link = "https://bbest.github.io/eds232-ml/")

# Update 411 title cell (w/ link)
winter[4,2] <- cell_spec("MEDS Capstone Course", "html", link = "https://allisonhorst.github.io/EDS_411AB_meds-capstone/")
...
spring[1,2] <- cell_spec("Modeling Environmental Systems", "html", link = "https://naomitague.github.io/ESM232_course/")

# Update 231 title cell (w/ link)
spring[2,2] <- cell_spec("Text and Sentiment Analysis for Environmental Problems", "html", link = "https://maro406.github.io/EDS_231-text-sentiment/")
